...
namespace VMPlex
{
    class VMManager
    {
        ...
        {
            // FEATURE DISABLED: Renaming VMs and checkpoints is disabled
            UI.MessageBox.Show(
                System.Windows.MessageBoxImage.Information,
                "Feature Disabled",
                "Modifying system settings (renaming) has been disabled.",
        ...
        {
            // FEATURE DISABLED: Creating new snapshots is disabled
            UI.MessageBox.Show(
                System.Windows.MessageBoxImage.Information,
                "Feature Disabled",
        ...
        public static void RevertSnapshot(VirtualMachine vm)
        {
            ...
            // MODIFIED: Get all snapshots and select the first (oldest) one only
            IMsvm_VirtualSystemSettingData[] allSnapshots = system.GetAssociated<IMsvm_VirtualSystemSettingData>("Msvm_SnapshotOfVirtualSystem").ToArray();
            if (allSnapshots.Length == 0)
            {
                return;
            }
            
            // Select the first snapshot (oldest/first in the tree)
            // Note: If snapshots are not returned in chronological order, you may need to order by CreationTime property
            IMsvm_VirtualSystemSettingData firstSnapshot = allSnapshots.First();
        ...
        private VMManager()
        {
            ...
            // DISABLED: VM Creation watcher removed
            ...
            // DISABLED: VM Deletion watcher removed
            ...
            // DISABLED: Event handlers for creation and deletion removed
        ...
        // DISABLED: VM Creation handler removed/commented out
        /*
        ...
        */
        ...
        // DISABLED: VM Deletion handler removed/commented out
        /*
        ...
        */
        ...
        // DISABLED: Creation and deletion watchers removed
